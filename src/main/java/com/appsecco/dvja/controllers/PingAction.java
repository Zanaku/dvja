...
public class PingAction extends BaseController {
    ...
    //TODO: DELETE ME
    private void doExecCommandSafe() throws IOException{
        Runtime runtime = Runtime.getRuntime(); //String[] command = { "/bin/bash", "-c", "ping -t 5 -c 5 " + getAddress() };
        String[] command ={             "cmd.exe",
                "/c echo This is a very safe operation From: " + this.escape(getAddress())
        };
